...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-content-main-main-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentMainMetricsMetricsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentMainMainModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _app_content_sections_sections_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/content/sections/sections.module */
    "./src/app/content/sections/sections.module.ts");
    /* harmony import */


    var _metrics_metrics_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./metrics/metrics.component */
    "./src/app/content/main/metrics/metrics.component.ts");
    /* harmony import */


    var _metrics_metrics_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    MainModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _gaxon_modules__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _app_content_sections_sections_module__WEBPACK_IMPORTED_MODULE_5__["SectionsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(appsRoutes)],
      declarations: [_metrics_metrics_component__WEBPACK_IMPORTED_MODULE_6__["MetricsComponent"]]
    })], MainModule);
    /***/
  },
  ...
  /***/
  function srcAppContentMainMetricsMetricsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentMainMetricsMetricsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _metrics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./metrics.service */
    "./src/app/content/main/metrics/metrics.service.ts");
    ...
    MetricsComponent.ctorParameters = function () {
      return [{
        type: _metrics_service__WEBPACK_IMPORTED_MODULE_2__["MetricsService"]
      }];
    };

    MetricsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-metrics',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./metrics.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/main/metrics/metrics.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./metrics.component.scss */
      "./src/app/content/main/metrics/metrics.component.scss"))["default"]]
    })], MetricsComponent);
    /***/
  },
  ...
  /***/
  function srcAppContentMainMetricsMetricsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(MetricsService, [{
        ...
        value: function resolve(route, state) {
          ...
          return new Promise(function (resolve, reject) {
            Promise.all([_this.getWidgets(), _this.getSimpleWidgets(), _this.getTrendingCards()]).then(function () {
              resolve();
            }, reject);
          });
        }
        ...
        value: function getWidgets() {
          ...
          return new Promise(function (resolve, reject) {
            _this2.http.get(_this2.widgetsUrl).subscribe(function (widgets) {
        ...
        key: "getSimpleWidgets",
        value: function getSimpleWidgets() {
          var _this3 = this;

          return new Promise(function (resolve, reject) {
            _this3.http.get(_this3.simpleWidgetsUrl).subscribe(function (widgets) {
              _this3.simpleWidgets = widgets;
              resolve(widgets);
            }, reject);
          });
        }
        ...
        key: "getTrendingCards",
        value: function getTrendingCards() {
          var _this4 = this;

          return new Promise(function (resolve, reject) {
            _this4.http.get(_this4.trendingCardsUrl).subscribe(function (cards) {
              _this4.trendingCards = cards;
              resolve(cards);
            }, reject);
          });
        }
    ...
    MetricsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], MetricsService);
    /***/
  }
}]);
//# sourceMappingURL=app-content-main-main-module-es5.js.map