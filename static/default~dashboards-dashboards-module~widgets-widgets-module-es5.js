...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~dashboards-dashboards-module~widgets-widgets-module"], {
  /***/
  ...
  /***/
  function srcAppContentMainWidgetsWidgetsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var WidgetsService = /*#__PURE__*/function () {
      function WidgetsService(http) {
        ...
        this.http = http;
        this.widgetsUrl = 'api/widgets-get'; // URL to web api
      ...
      _createClass(WidgetsService, [{
        ...
        value: function resolve(route, state) {
          ...
          return new Promise(function (resolve, reject) {
            Promise.all([_this2.getWidgets(), _this2.getTasksList()]).then(function () {
              resolve();
            }, reject);
          });
        }
        ...
        value: function getWidgets() {
          ...
          return new Promise(function (resolve, reject) {
            _this3.http.get(_this3.widgetsUrl).subscribe(function (widgets) {
              _this3.widgets = widgets;
              resolve(widgets);
            }, reject);
          });
        }
        ...
        value: function getTasksList() {
          ...
          return new Promise(function (resolve, reject) {
            _this4.http.get(_this4.tasksUrl).subscribe(function (response) {
              _this4.tasks = response;

              _this4.onTasksChanged.next(_this4.tasks);

              resolve(_this4.tasks);
            }, reject);
          });
        }
      }, {
        ...
        value: function updateTask(task) {
          ...
          return new Promise(function (resolve, reject) {
            _this5.http.post(_this5.tasksUrl + '/' + task.id, Object.assign({}, task)).subscribe(function (response) {
              _this5.getTasksList().then(function (tasks) {
                resolve(tasks);
              }, reject);
            });
          });
    ...
    WidgetsService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    WidgetsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], WidgetsService);
    /***/
  }
}]);
//# sourceMappingURL=default~dashboards-dashboards-module~widgets-widgets-module-es5.js.map