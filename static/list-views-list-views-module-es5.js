...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["list-views-list-views-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentExtraViewsListViewsAdvancedListAdvancedListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentExtraViewsListViewsBasicListBasicListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentExtraViewsListViewsAdvancedListAdvancedListComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentExtraViewsListViewsAdvancedListAdvancedListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AdvancedListComponent", function () {
    ...
    var _list_views_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../list-views.service */
    ...
    var AdvancedListComponent = /*#__PURE__*/function () {
      function AdvancedListComponent(listService) {
        _classCallCheck(this, AdvancedListComponent);
      ...
      _createClass(AdvancedListComponent, [{
        key: "ngOnInit",
    ...
    AdvancedListComponent.ctorParameters = function () {
      return [{
        type: _list_views_service__WEBPACK_IMPORTED_MODULE_2__["ListViewsService"]
      }];
    };

    AdvancedListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-advanced-list',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./advanced-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/extra-views/list-views/advanced-list/advanced-list.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./advanced-list.component.scss */
      "./src/app/content/extra-views/list-views/advanced-list/advanced-list.component.scss"))["default"]]
  ...
  /***/
  function srcAppContentExtraViewsListViewsBasicListBasicListComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentExtraViewsListViewsBasicListBasicListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BasicListComponent", function () {
    ...
    var BasicListComponent = /*#__PURE__*/function () {
      function BasicListComponent(listService) {
        _classCallCheck(this, BasicListComponent);

        this.listService = listService;
        this.usersList = this.listService.usersList;
      }

      _createClass(BasicListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    BasicListComponent.ctorParameters = function () {
      return [{
        type: _list_views_service__WEBPACK_IMPORTED_MODULE_2__["ListViewsService"]
      }];
    };

    BasicListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-basic-list',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./basic-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/extra-views/list-views/basic-list/basic-list.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./basic-list.component.scss */
      "./src/app/content/extra-views/list-views/basic-list/basic-list.component.scss"))["default"]]
    })], BasicListComponent);
    /***/
  },
  ...
  /***/
  function srcAppContentExtraViewsListViewsListViewsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListViewsModule", function () {
      return ListViewsModule;
    });
    /* harmony import */
    ...
    var _basic_list_basic_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./basic-list/basic-list.component */
    "./src/app/content/extra-views/list-views/basic-list/basic-list.component.ts");
    /* harmony import */


    var _list_views_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./list-views.service */
    "./src/app/content/extra-views/list-views/list-views.service.ts");
    /* harmony import */


    var _advanced_list_advanced_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./advanced-list/advanced-list.component */
    "./src/app/content/extra-views/list-views/advanced-list/advanced-list.component.ts");
    ...
    var ListViewsModule = function ListViewsModule() {
      _classCallCheck(this, ListViewsModule);
    };

    ListViewsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _gaxon_modules__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], ng_simple_slideshow__WEBPACK_IMPORTED_MODULE_5__["SlideshowModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)],
      declarations: [_basic_list_basic_list_component__WEBPACK_IMPORTED_MODULE_6__["BasicListComponent"], _advanced_list_advanced_list_component__WEBPACK_IMPORTED_MODULE_8__["AdvancedListComponent"]]
    })], ListViewsModule);
    /***/
  },
  ...
  /***/
  function srcAppContentExtraViewsListViewsListViewsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListViewsService", function () {
      return ListViewsService;
    });
    /* harmony import */
    ...
    var ListViewsService = /*#__PURE__*/function () {
      function ListViewsService(http) {
        _classCallCheck(this, ListViewsService);

        this.http = http;
      }

      _createClass(ListViewsService, [{
        key: "resolve",
        value: function resolve(route, state) {
          var _this = this;

          return new Promise(function (resolve, reject) {
            Promise.all([_this.getUsers(), _this.getRealEstates()]).then(function () {
              resolve();
            }, reject);
          });
        }
        ...
        value: function getUsers() {
          ...
          return new Promise(function (resolve, reject) {
            _this2.http.get('api/list-views-users').subscribe(function (response) {
              _this2.usersList = response;
              resolve(response);
            }, reject);
          });
        }
        ...
        value: function getRealEstates() {
          ...
          return new Promise(function (resolve, reject) {
            _this3.http.get('api/list-views-realestates').subscribe(function (response) {
              _this3.realestates = response;
              resolve(response);
            }, reject);
          });
        }
    ...
    ListViewsService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    ListViewsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], ListViewsService);
    /***/
  }
}]);
//# sourceMappingURL=list-views-list-views-module-es5.js.map