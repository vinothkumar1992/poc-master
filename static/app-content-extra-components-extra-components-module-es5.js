...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-content-extra-components-extra-components-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentExtraComponentsNotificationsNotificationsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentExtraComponentsSweetAlertsSweetAlertsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentExtraComponentsExtraComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ExtraComponentsModule", function () {
    ...
    var _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _sweet_alerts_sweet_alerts_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./sweet-alerts/sweet-alerts.component */
    ...
    var ExtraComponentsModule = function ExtraComponentsModule() {
      _classCallCheck(this, ExtraComponentsModule);
    };

    ExtraComponentsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _gaxon_modules__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_5__["SweetAlert2Module"].forRoot(), ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastContainerModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)],
      declarations: [_sweet_alerts_sweet_alerts_component__WEBPACK_IMPORTED_MODULE_7__["SweetAlertsComponent"], _notifications_notifications_component__WEBPACK_IMPORTED_MODULE_8__["NotificationsComponent"]]
  ...
  /***/
  function srcAppContentExtraComponentsNotificationsNotificationsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentExtraComponentsNotificationsNotificationsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var lodash_es__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! lodash-es */
    "./node_modules/lodash-es/lodash.js");
    /* harmony import */


    var _gaxon_components_notifications_notyf_toast__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @gaxon/components/notifications/notyf.toast */
    "./src/gaxon/components/notifications/notyf.toast.ts");
    /* harmony import */


    var _gaxon_components_notifications_pink_toast__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @gaxon/components/notifications/pink.toast */
    ...
    var quotes = [{
      ...
      title: '',
      message: "Supports Angular ".concat(_angular_core__WEBPACK_IMPORTED_MODULE_1__["VERSION"].full)
    }];

    var NotificationsComponent = /*#__PURE__*/function () {
      function NotificationsComponent(title, toastr) {
        ...
        var current = title.getTitle();
        title.setTitle("".concat(current, ": Notifications"));
      }
      ...
      _createClass(NotificationsComponent, [{
        ...
        value: function getMessage() {
          var randomMessage = quotes[Object(lodash_es__WEBPACK_IMPORTED_MODULE_4__["random"])(0, quotes.length - 1)];
          var m = randomMessage.message;
          var t = randomMessage.title;
          return {
            message: m,
            title: t
          };
        ...
        key: "showProgressBar",
        value: function showProgressBar(progressAnimation) {
          var opt = Object(lodash_es__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(this.options);
          ...
          var toastType = this.options.iconClasses[this.type];
          this.toastr.show('You have pressed the Progress Bar button.', 'Progress Bar!', opt, toastType);
        }
      }, {
        key: "changePosition",
        value: function changePosition(positionClass) {
          var opt = Object(lodash_es__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(this.options);
        ...
        key: "openInlinePosition",
        value: function openInlinePosition() {
          this.toastr.overlayContainer = this.inlineContainer;

          var _this$getMessage = this.getMessage(),
              message = _this$getMessage.message,
              title = _this$getMessage.title;
        ...
        key: "openToastNoAnimation",
        value: function openToastNoAnimation() {
          var _this$getMessage2 = this.getMessage(),
              message = _this$getMessage2.message,
              title = _this$getMessage2.title;
        ...
        value: function openPinkToast() {
          ...
          var _this$getMessage3 = this.getMessage(),
              message = _this$getMessage3.message,
              title = _this$getMessage3.title;

          this.toastr.show(message, title, opt);
        }
      }, {
        key: "openNotyf",
        value: function openNotyf() {
          var opt = Object(lodash_es__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(this.options);
          ...
          var _this$getMessage4 = this.getMessage(),
              message = _this$getMessage4.message,
              title = _this$getMessage4.title;
    ...
    NotificationsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/extra-components/notifications/notifications.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./notifications.component.scss */
      "./src/app/content/extra-components/notifications/notifications.component.scss"))["default"]]
  ...
  /***/
  function srcAppContentExtraComponentsSweetAlertsSweetAlertsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentExtraComponentsSweetAlertsSweetAlertsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SweetAlertsComponent", function () {
    ...
    var SweetAlertsComponent = /*#__PURE__*/function () {
      function SweetAlertsComponent() {
        _classCallCheck(this, SweetAlertsComponent);
      ...
      _createClass(SweetAlertsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "openAutoClose",
        value: function openAutoClose(event) {
          var _this = this;

          this.timerInterval = setInterval(function () {
            _this.secondsLeft = _this.secondsLeft - 50;
          }, 50);
        }
      }, {
        key: "closeAutoClose",
        value: function closeAutoClose(event) {
          this.secondsLeft = 2000;
        ...
        key: "deleteCancel",
        value: function deleteCancel() {
          this.deleteCancelSwal.fire();
        }
      }, {
        key: "saveEmail",
        value: function saveEmail(email) {// ... save user email
        }
      }, {
        key: "handleRefusalToSetEmail",
        value: function handleRefusalToSetEmail(dismissMethod) {// dismissMethod can be 'cancel', 'overlay', 'close', and 'timer'
          // ... do something
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('deleteSwal', {
      "static": true
    })], SweetAlertsComponent.prototype, "deleteSwal", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('autoCloseSwal', {
      "static": true
    })], SweetAlertsComponent.prototype, "autoCloseSwal", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('deleteConfirmSwal', {
      "static": true
    })], SweetAlertsComponent.prototype, "deleteConfirmSwal", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('deleteCancelSwal', {
      "static": true
    })], SweetAlertsComponent.prototype, "deleteCancelSwal", void 0);
    SweetAlertsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-sweet-alerts',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./sweet-alerts.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/extra-components/sweet-alerts/sweet-alerts.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sweet-alerts.component.scss */
      "./src/app/content/extra-components/sweet-alerts/sweet-alerts.component.scss"))["default"]]
    })], SweetAlertsComponent);
    /***/
  }
}]);
//# sourceMappingURL=app-content-extra-components-extra-components-module-es5.js.map